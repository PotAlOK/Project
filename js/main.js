/* variables */
let citylist = ['Москва', 'Новороссийск', 'Караганда', 'Магадан', 'Люберцы', 'Севастополь', 'Ярославль', 'Вологда', 'Владивосток', 'Барнаул', 'Петрозаводск', 'Самара', 'Саратов', 'Тверь', 'Вашингтон', 'Париж', 'Пермь', 'Екатеринбург', 'Новосибирск', 'Калининград'];
let rangemin = 0;
let rangemax = 300;
let startbasket = [
    {
        id: 1,
        name: 'Автомобильный холодильник WORLD RIDER 24л.',
        price: 4990,
        quantity: 1,
        link: ''
    },
    {
        id: 2,
        name: 'Резак газовый Kovea Multi Purpose Torch с пьезоподжигом.',
        price: 4100,
        quantity: 1,
        link: ''
    },
    {
        id: 111,
        name: 'Аккумулятор MUTLU 60 а/ч, обратная полярность серый',
        price: 7700,
        quantity: 1,
        link: ''
    },
    {
        id: 11,
        name: 'Моторное масло SHELL HELIX HX8 5w40',
        price: 1474,
        quantity: 1,
        link: ''
    }
